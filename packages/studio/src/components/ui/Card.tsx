...
>(({ className = "", ...props }, ref) => (
  <div
    ref={ref}
    className={`rounded-lg border border-zinc-800 bg-zinc-950/80 text-zinc-100 shadow-sm ${className}`}
    {...props}
  />
))
...
>(({ className = "", ...props }, ref) => (
  <h3
    ref={ref}
    className={`font-semibold tracking-tight text-white text-base ${className}`}
    {...props}
  />
))
