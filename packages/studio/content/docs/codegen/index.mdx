...
```mermaid
graph TD
  OpenAPI["OpenAPI 2.0 / 3.0 / 3.1 Spec"] --> Gen["PostMCP Code Generator"]
  Gen --> TS["TypeScript MCP SDK<br/>- Strict Zod schemas<br/>- Embedded Token Diet masks<br/>- stdio & Streamable HTTP"]
  Gen --> PY["Python FastMCP Server<br/>- Strict Pydantic models<br/>- Async HTTP client<br/>- stdio & SSE ready"]
```
