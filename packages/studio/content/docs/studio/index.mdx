...
```mermaid
flowchart LR
  Spec["<b>Spec / Preset</b><br/>60+ APIs"]
  --> Explorer["<b>API Explorer</b><br/>Search & filters"]
  --> Curator["<b>Diet Curator</b><br/>JSONPath masks"]
  --> Sandbox["<b>Live Sandbox</b><br/>Multi-provider test"]
```
