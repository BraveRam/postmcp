...
```mermaid
graph TD
  Header["Studio Header: Brand | Spec Selector | Presets Catalog | Import Spec | AI Sandbox"]
  Header --> P1["API Explorer<br/>- Search tools & filters<br/>- HTTP method badges<br/>- Safety risk tiers<br/>- JIT status"]
  Header --> P2["Endpoint Inspector & Curator<br/>- Parameter tables<br/>- JSONPath field mask editor<br/>- Schema preview<br/>- Macro composer"]
  Header --> P3["Live Sandbox & Diet Comparator<br/>- Real-time diff & token counter<br/>- AI chat interface<br/>- Multi-provider model testing"]
```
