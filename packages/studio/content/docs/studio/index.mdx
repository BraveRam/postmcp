...
```
+-------------------------------------------------------------------------+
|  [Header] PostMCP Studio | Spec Title | Presets | Import | AI Sandbox   |
+-------------------------------------------------------------------------+
|                 |                                   |                   |
|  API Explorer   |       Endpoint Inspector          |  Live Sandbox /   |
|                 |               &                   |  Token Diet       |
|  - Search tools |       Token Diet Curator          |  Curator          |
|  - Method tags  |                                   |                   |
|  - Risk badges  |  - Parameter tables               |  - Real-time diff |
|  - JIT status   |  - JSONPath field mask editor     |  - AI Elements    |
|                 |  - Schema preview                 |  - Multi-provider |
|                 |                                   |                   |
+-------------------------------------------------------------------------+
```
