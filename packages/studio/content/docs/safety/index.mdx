...
```mermaid
flowchart LR
  Call["<b>Tool Call</b><br/>Agent request"]
  --> Tier["<b>1. Risk Tier</b><br/>Read / Write / Crit"]
  --> Dry["<b>2. Dry-Run</b><br/>Simulate or pass"]
  --> SSRF["<b>3. SSRF Guard</b><br/>Block private IPs"]
  --> Exec["<b>Upstream API</b><br/>Safe execution"]
```
