...
```mermaid
flowchart LR
  Client["<b>LLM Agent</b><br/>Claude / Cursor"]
  --> P1["<b>1. Ingest</b><br/>OpenAPI & $refs"]
  --> P2["<b>2. JIT Router</b><br/>Hot tools"]
  --> P3["<b>3. Safety</b><br/>Risk & SSRF"]
  --> P4["<b>4. Context</b><br/>Tenant & cursor"]
  --> P5["<b>5. Token Diet</b><br/>-93% Tokens"]
  --> API["<b>Upstream API</b><br/>REST Endpoints"]
```
