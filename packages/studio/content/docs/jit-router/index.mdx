...
```mermaid
flowchart LR
  Spec["<b>OpenAPI Spec</b><br/>80+ operations"]
  --> JIT["<b>Hybrid JIT</b><br/>Hot-tool scorer"]
  JIT --> Hot["<b>Hot Tools</b><br/>Top 5-7 turn 1"]
  JIT --> Search["<b>tool_search</b><br/>On-demand pool"]
  Hot --> Agent["<b>AI Agent</b><br/>Instant turn 1"]
  Search --> Agent
```
